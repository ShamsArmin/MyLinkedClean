...
import { Link as LinkType, ProfileStats } from "@shared/schema";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function SimpleDashboard() {
  ...
  const { data: stats = { views: 0, clicks: 0, ctr: 0, score: 40 }, isLoading: isLoadingStats } = useQuery<ProfileStats>({
    queryKey: ["/api/stats"],
    enabled: !!user,
  });
