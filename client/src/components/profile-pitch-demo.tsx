...
export function ProfilePitchDemo() {
  ...
  const demoProfile = {
    ...
    password: '',
    name: 'Alex Johnson',
    bio: 'Professional web developer with 5+ years of experience in creating responsive and user-friendly websites. Specialized in React, Node.js, and modern JavaScript frameworks.',
    ...
    collaborators: [],
    pitchMode: true,
    pitchDescription: 'I am a web developer passionate about creating intuitive and impactful digital experiences. With expertise in frontend and backend technologies, I deliver complete solutions that help businesses achieve their goals online.',
  ...
  const demoLinks = [
    ...
    },
    {
      ...
      url: 'https://github.com/alexj-dev',
      clicks: 92,
      views: 178,
      featured: false,
      order: 3,
