...
interface OptimizeLinksProps {
  links: Link[];
  onOptimizeLink: (link: Link) => void;
  onClose: () => void;
}
...
export function OptimizeLinksSection({ links, onOptimizeLink, onClose }: OptimizeLinksProps) {
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          ...
          <h2 className="text-xl font-bold">Optimize Your Links</h2>
        </div>
      </div>
